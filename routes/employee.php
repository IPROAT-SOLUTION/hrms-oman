...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::group(['prefix' => 'templates'], function () {
        Route::get('/employeeTemplate', ['as' => 'templates.employeeTemplate', 'uses' => 'Employee\EmployeeController@exportAsTemplate']);
    });
    ...
    Route::get('viewEmployeeDocument/{id}/{key}', function ($id, $key) {
        $employee = Employee::find($id);
        return view('admin.employee.employee.viewFile', ['employee' => $employee, 'key' => $key]);
    });
});
