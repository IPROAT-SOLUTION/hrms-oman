...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('downloadMonthlyAttendanceExcel', 'Attendance\AttendanceReportController@monthlyExcelExportFromCollection');
    Route::get('downloadMonthlyAttendancePdf', 'Attendance\AttendanceReportController@monthlyPdfExportFromCollection');
    Route::get('downloadSummaryAttendancePdf', 'Attendance\AttendanceReportController@summaryPdfExportFromCollection');
...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::get('downloadMusterReport', 'Attendance\AttendanceReportController@downloadMusterReport');
