...
Route::get('getEmployeeEmail', [GenerateSalarySheet::class, 'getEmployeeEmail'])->name('getEmployeeEmail');
Route::post('verifyOtp', [GenerateSalarySheet::class, 'verifyOtp'])->name('verifyOtp');
