...
<script type="text/javascript">
    var table = $('#employeeShiftMaster').DataTable({
        autoFill: true,
        ordering: false,
        processing: false,
        colReorder: false,
    ...
    function downloadExcel() {
        $yearAndMonth = $('.monthField').val();
        window.location.href = "{{ url('shiftDetails/download/?yearAndMonth=') }}" + $yearAndMonth;
    }
</script>
@endsection
