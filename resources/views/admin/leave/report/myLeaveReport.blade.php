                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive" style="font-size: 12px;">
                            <table id="myLeaveReport" class="table table-bordered">
...
<script>
    $(document).ready(function() {
        var table = $('#myLeaveReport').DataTable({
            ordering: false,
            dom: 'lBfrtip',
            buttons: [{
        ...
        function downloadExcel() {
            ...
            $to_date = $('.to_date').val();
            window.location.href = "{{ url('/downloadMyLeaveReportExcel') }}" + "?from_date=" +
                $from_date + '&to_date=' +
        ...
        function downloadPdf() {
            ...
            $from_date = $('.from_date').val();
            $to_date = $('.to_date').val();
            window.location.href = "{{ url('/downloadMyLeaveReport') }}" + "?from_date=" +
                $from_date + '&to_date=' +
                $to_date + '&department_id=' + $department_id;
        }
    });
