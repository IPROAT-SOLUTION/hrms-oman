                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <hr>
                                {{ Form::open(['route' => ['requestedApplication.approveOrRejectManagerLeaveApplication', $leaveApplicationData->leave_application_id], 'method' => 'PUT', 'files' => 'true', 'id' => 'leaveApproveOrRejectForm']) }}
