                            ...
                            <div class="row col-md-offset-1">
                                ...
                                {{-- <div class="col-md-2" style="margin-right: 12px">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('day_name', $weekList, Input::old('day_name'), ['class' => 'form-control day_name required multiple ', 'id' => 'day_name', 'onchange' => 'getData(1);']) }}
                                    </div>
                                </div> --}}
                                <div class="col-md-2" style="margin-right: 12px">
                                    <div class="form-group">
                                        <label class="control-label" for="branch_id">Holiday:</label>
                                        <select name="day_name[]" class="form-control day_name required select2" multiple>
