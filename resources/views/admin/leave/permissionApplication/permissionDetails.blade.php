                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <hr>
                                {{ Form::open(['route' => ['requestedPermissionApplication.approveOrRejectPermissionApplication', $leaveApplicationData->leave_permission_id], 'method' => 'PUT', 'files' => 'true', 'id' => 'permissionApproveOrRejectForm']) }}
