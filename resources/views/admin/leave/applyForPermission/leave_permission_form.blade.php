                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('leave.applied_permission_count')<span
                                                class="validateRq">*</span></label>
                                        {!! Form::text(
                                            '',
                                            '',
...
<script>
        ...
        if (valuestart !== '' && valuestop !== '') {
            ...
            if (startTime > endTime) {
                ...
                if (hours > 2 || (hours === 2 && minutes > 0)) {
                    $.toast({
                        heading: 'Warning',
                        text: 'Permission only allows a maximum of 2 hours',
                        position: 'top-right',
                        loaderBg: '#ff6849',
                        icon: 'warning',
                        hideAfter: 3000,
                    ...
                    $('.permission_duration').val(hours.toString().padStart(2, '0') + ':' + minutes.toString().padStart(2, '0'));
        ...
        if ($(".permission_date").val() == '' && $(".employee_id").val() != '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('.current_balance').val(data.checkpermissions);
                    if (data >= 3) {
                        $.toast({
                            heading: 'Warning',
    ...
    $(document).on("change", ".permission_date, .employee_id, .timePicker", function() {
        permissionBalance();
    });
