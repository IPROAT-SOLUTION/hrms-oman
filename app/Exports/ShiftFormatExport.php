...
class ShiftFormatExport implements WithHeadings, FromCollection, WithProperties, WithEvents
{
                ...
                foreach ($cell_range as $drop_column) {
                    ...
                    for ($i = 0; $i < $row_count; $i++) {
                        ...
                        if (in_array($drop_column, $this->extraData['holidays'])) {
                            $validation->setPrompt('Selected date is Weekoff! Are you sure to assign shift?.');
    ...
    {
        return [
            'creator' => 'muscat-insurance',
            'lastModifiedBy' => 'muscat-insurance',
            'title' => 'EmployeeShiftInfo',
            'description' => 'muscat-insurance - EmployeeShiftInfo',
            'subject' => 'muscat-insurance - EmployeeShiftInfo',
