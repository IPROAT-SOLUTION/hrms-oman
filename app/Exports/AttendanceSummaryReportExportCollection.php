...
class AttendanceSummaryReportExportCollection implements FromCollection, WithHeadings, WithProperties, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use (
                ...
                $this->cellRangeArr = $cellRangeArr;
    ...
    public function columnFormats(): array
    {
        ...
        // foreach ($this->cellRangeArr ?? [] as $key => $value) {
        //     $array[$value] = NumberFormat::FORMAT_TEXT;
        // }
        return $array;
    }
}
